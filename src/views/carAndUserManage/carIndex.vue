<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column :label="$t('userAndCarTable.approvedSeating')" min-width="80" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('userAndCarTable.remark')" align="center" width="180">
        <template slot-scope="scope">

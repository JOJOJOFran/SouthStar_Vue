  ...
  <div class="app-container">
    <div class="filter-container">
      <el-form ref="dataForm" label-position="left" label-width="80px" style="margin-left:50px;">
          ...
          <el-col :span="8">
            <el-form-item :label="$t('statisticalTable.changeCondition')">
               <el-checkbox-group 
                  ...
                  :min="1"
                  :max="3">
                  <el-checkbox v-for="type in selectTypes" 
                  :label="type" 
                  :key="type"
                  @change="checked=>handleCheckedTypeChange(checked,type)">{{type}}</el-checkbox>
                </el-checkbox-group>
            </el-form-item>
          </el-col>
          <el-col :span="8">
        ...
        <el-row>
          <el-col :span="6" v-show="showDriver">
            <el-form-item label-width="80px" :label="$t('statisticalTable.driverName')">
          ...
          <el-col :span="6" v-show="showPlate">
            <el-form-item label-width="80px" :label="$t('statisticalTable.plateNumber')">
          ...
          <el-col :span="6" v-show="showDepartment">

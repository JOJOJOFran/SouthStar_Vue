<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column :label="$t('userAndCarTable.driverName')" prop="id" sortable="custom" align="center" width="120px">
        <template slot-scope="scope">
          <span style="color:#409EFF">{{ scope.row.name }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('userAndCarTable.sex')" prop="id" sortable="custom" align="center" width="120px">
        <template slot-scope="scope">
      ...
      <!-- <el-table-column :label="$t('userAndCarTable.delete')" align="center" width="auto">
        <template slot-scope="scope">
          <el-button type="primary" size="mini" style="background-color: #D74C29" @click="handleDelete(scope.row)">{{ scope.row.delete }}</el-button>
        </template>
      </el-table-column> -->
    </el-table>
...
import { driverList, driverDelete, driverAdd, driverItem, driverUpdate, getImageToken, deptList } from '@/api/userAndCar'
  import { driverEnableList} from '@/api/applyCar'
...
export default {
  ...
  data() {
    return {
      ...
      driverStatusOptions: [
        { key: 1, display_name: '待岗' }, { key: 2, display_name: '值班' }, { key: 3, display_name: '请假' },
        { key: 4, display_name: '离职' }, { key: 5, display_name: '休假' }, { key: 6, display_name: '加班' }
      ],
      basicColorOptions: [],
      basicBrandOptions: [],
  ...
  methods: {
    ...
    getList() {
      ...
      driverEnableList(this.listQuery).then(response => {

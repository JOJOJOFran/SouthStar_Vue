        ...
        <el-row>
          <el-col :span="12">
            <el-form-item :label="$t('applyTable.userDept')" prop="dept">
              <el-select v-model="addParam.departmentId" class="filter-item" @change="deptChange" placeholder="请选择" :disabled="readOnlyFlag">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item :label="$t('applyTable.carType')" prop="carType">
              <el-select v-model="addParam.carType" class="filter-item" placeholder="请选择" :disabled="readOnlyFlag">
          ...
          <el-col :span="12">
            <el-form-item :label="$t('applyTable.useArea')" prop="useArea">
              <el-select v-model="addParam.useArea" class="filter-item" placeholder="请选择" :disabled="readOnlyFlag">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item :label="$t('applyTable.carProperty')" prop="carProperty">
              <el-select v-model="addParam.carProperty" class="filter-item" placeholder="请选择" :disabled="readOnlyFlag">

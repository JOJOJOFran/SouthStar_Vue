  ...
  <div class="app-container">
    <div class="filter-container">
      <el-form ref="dataForm" label-position="left" label-width="80px" style="margin-left:50px;">
        <el-row>
          <el-col :span="8">
            <el-form-item :label="$t('vehicleManageTable.plateNum')" prop="type">
    ...
    <el-table
      ...
      <el-table-column :label="$t('vehicleManageTable.insuranceStartDate')" width="auto" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.insuranceStartDate }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('vehicleManageTable.insuranceEndDate')" min-width="auto">
        <template slot-scope="scope">
          <span>{{ scope.row.insuranceEndDate }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('vehicleManageTable.insuranceType')" width="auto" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('vehicleManageTable.insuranceFee')" width="auto" align="center">
        <template slot-scope="scope">
